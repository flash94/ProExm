...
public class ModelExpiredItems {
    ...
    public ModelExpiredItems(String id, String itemName, String itemImage, String itemPrice, String itemManufacturer, String itemDesc, String itemExp, String itemMfd, int daysToExpiry, String itemStatus, String addedTime, String updatedTime) {
        this.id = id;
